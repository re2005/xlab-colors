...
Game.Game.prototype = {
    ...
    create: function () {
        ...
        window.ga('send', 'event', 'Game', 'Load', this.currentLevel);
    ...
    dropBottle: function (bottle) {
        ...
        window.ga('send', 'event', 'Game', 'Drop', bottle);
    ...
    fillTube: function (obj1, obj2) {
        ...
        window.ga('send', 'event', 'Game', 'HitTube', parseInt(obj2.key.substring(7, 8)));
    ...
    hitRat: function (obj1, obj2) {
        ...
        window.ga('send', 'event', 'Game', 'HitRat', parseInt(obj2.key.substring(7, 8)));
    ...
    hitRolling: function (obj1, obj2) {
        window.ga('send', 'event', 'Game', 'HitRolling', parseInt(obj2.key.substring(7, 8)));
        obj2.destroy();
    ...
    gameOver: function () {
        ...
        if (this.gameWon) {
            if (this.currentLevel == this.MaxLevels) {
                window.ga('send', 'event', 'Game', 'GameWon', this.currentLevel);
                window.ga('send', 'event', 'Game', 'Score', this.counter);
                this.quitGame();
                this.state.start('GameWon');
                return;
            }
            window.ga('send', 'event', 'Game', 'LevelComplete', this.currentLevel);
            ...
            window.ga('send', 'event', 'Game', 'GameOver', this.currentLevel);
            this.quitGame();
    ...
    helpGame: function () {
        window.ga('send', 'event', 'Game', 'Help', this.currentLevel);
        this.pauseGame();
        this.level.help();
    ...
    hideHelpGame: function () {
        window.ga('send', 'event', 'Game', 'HideHelp', this.currentLevel);
        this.level.hideInfo();
    ...
    pauseGame: function (button) {
        window.ga('send', 'event', 'Game', 'Pause', this.currentLevel);
    ...
    unpauseGame: function (button) {
        window.ga('send', 'event', 'Game', 'UnPause', this.currentLevel);
    ...
    resolveMusic: function () {
        if (this.mute) {
            window.ga('send', 'event', 'Game', 'Mute', this.currentLevel);
        ...
        if (this.gameAudio.paused) {
            ...
            window.ga('send', 'event', 'Game', 'UnMute', this.currentLevel);
        } else {
            this.gameAudio.play();
        }
